...
<div>
<span class="usm-hero-tag">EGEI · Graduate course</span>
<h1>Machine Learning — EGEI</h1>
<p>Learn the foundations of machine learning while working the way data teams actually work today:
side by side with an AI coding assistant. You will not just prompt it — you will read, test and
defend every line it writes.</p>
</div>
<img src="images/usm_shield.png" alt="Universidad Técnica Federico Santa María">
</div>
...
Regression, classification, resampling, regularization and an introduction to neural networks —
with emphasis on *why* a model works, not only on calling `.fit()`.
</div>
...
<div class="usm-card" markdown>
### 📈 Two real projects
Everything is assessed through two end-to-end projects on real data, delivered with code, a short
report and a live presentation.
</div>
...
### Sebastián Azócar
<span class="usm-profile-role">Data Scientist @ LATAM Airlines Group · Lecturer</span>
